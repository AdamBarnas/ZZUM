...
// INIT PORT
motor.STEP_Port = GPIOA; motor.STEP_Pin = GPIO_PIN_0;
motor.DIR_Port  = GPIOA; motor.DIR_Pin  = GPIO_PIN_1;
motor.EN_Port   = GPIOA; motor.EN_Pin   = GPIO_PIN_2;
motor.M0_Port   = GPIOA; motor.M0_Pin   = GPIO_PIN_3;
motor.M1_Port   = GPIOA; motor.M1_Pin   = GPIO_PIN_4;
motor.M2_Port   = GPIOA; motor.M2_Pin   = GPIO_PIN_5;
motor.htim      = &htim3;

// INIT MOTOR
Stepper_Init(&motor);
Stepper_Enable(&motor);
Stepper_SetMicrostep(&motor, 16);
